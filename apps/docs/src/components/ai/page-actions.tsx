...
import { trackDocsActionClick } from "@/lib/analytics";
...
export function ViewOptions({
  ...
  const items = useMemo<ViewOptionItem[]>(() => {
    const pathname = markdownUrl?.replace(MDX_EXTENSION_REGEX, "") ?? "/";
    const pageUrl = typeof window === "undefined" ? pathname : new URL(pathname, window.location.origin).toString();
    const q = `Read ${pageUrl}, I want to ask questions about it.`;

    const items: ViewOptionItem[] = [];
