...
description: Use FileMaker scripts for secure business logic behind WebViewer apps.
---

FileMaker scripts are the backend for many hybrid app workflows. The WebViewer handles the interface, while scripts perform privileged work inside FileMaker.
...
- [Data Access](/docs/hybrid-apps/data-access)
- [WebViewer package docs](/docs/webviewer)
