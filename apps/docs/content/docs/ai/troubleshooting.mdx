...
If FileMaker says the ProofKit plug-in failed to load, report a bug in the [ProofKit community](https://community.ottomatic.cloud/c/proofkit).

### The plug-in is missing

If FileMaker says the ProofKit plug-in is missing, download and install ProofKit again.

If you already downloaded and installed it and still see the missing plug-in error, report a bug in the [ProofKit community](https://community.ottomatic.cloud/c/proofkit).
