...
Creating a ProofKit project for a FileMaker WebViewer is covered in the [ProofKit for Coding Agents getting started guide](/docs/ai/getting-started). This document highlights the CLI-specific WebViewer workflow.
...
Refer to the [ProofKit for Coding Agents getting started guide](/docs/ai/getting-started) for the full install, build, and deploy journey.
