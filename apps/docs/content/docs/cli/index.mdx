...
<Callout title="New to ProofKit AI?">
  Start with the [ProofKit AI getting started guide](/docs/ai/getting-started) for the v2 install, agent, Web Viewer, and deployment journey.
</Callout>
...
A library for interacting with the FileMaker Web Viewer.
  </Card>
