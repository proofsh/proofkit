...
The Web Viewer template scaffolded by the ProofKit CLI already wires this up. If you are configuring a project by hand, add the plugin to your `vite.config.ts`:
